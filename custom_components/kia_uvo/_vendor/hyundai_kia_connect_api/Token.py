...
class Token:
    ...
    def to_dict(self) -> dict:
        """Convert renewable token material to a JSON-serializable dict."""
        data = asdict(self)

        # Credentials remain in Home Assistant's config entry and must not be
        # duplicated in the persisted token payload.
